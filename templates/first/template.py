# -*- coding: UTF-8 -*-
# Хочется проверить что всё работает!
...
text_layer = TextLayer(font_place=path + "/DINProMedium.ttf",
                       font_size=trunc(float(Layer.image_height) / 40), font_color=(255, 255, 255),
                       text=u"АДАПТАЦИЯ\nК ЛЮБОЙ СИТУАЦИИ")
text_layer.x = x * 2
